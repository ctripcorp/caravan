...
public class GoogleProtobuf2Serializer implements StreamSerializer, BytesSerializer {

    public static final GoogleProtobuf2Serializer INSTANCE = new GoogleProtobuf2Serializer();

    private ProtobufMapperWrapper _mapperWrapper;

    private GoogleProtobuf2Serializer() {
        ProtobufConfig protobufConfig = new ProtobufConfig();
        protobufConfig.setEnumMode(EnumMode.ByValue);

        _mapperWrapper = new ProtobufMapperWrapper(protobufConfig);
