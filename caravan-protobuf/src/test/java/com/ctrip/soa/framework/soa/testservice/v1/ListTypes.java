...
/**
 * <p>ListTypes complex type的 Java 类。
 * 
 ...
 *         &lt;element name="durationType" type="{http://www.w3.org/2001/XMLSchema}duration" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "ListTypes", propOrder = {
    "byteType",
    "shortType",
    "intType",
    "longType",
...
public class ListTypes {
    ...
    protected List<Duration> durationType;
    @XmlElement(type = Integer.class)
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the durationType property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDurationType().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Duration> getDurationType() {
        if (durationType == null) {
            durationType = new ArrayList<Duration>();
        }
    ...
    public void setDurationType(List<Duration> value) {
